...
const SideNavbar = () => {
  ...
  return (
    <div className="h-screen bg-[#FCFCFC] w-[22%] flex flex-col">
      {/* Title Onehub Admin */}
      <div className="px-6 py-9 flex flex-row gap-1 items-center justify-start text-xl">
          ...
          return (
            ...
            >
              {selectedSection === option ? (
                <div className="h-full w-1 rounded-md bg-googleBlue-500"></div>
              ) : (
                <div className="h-full w-1 rounded-md bg-white"></div>
              )}
              <div
